class AddTable < ActiveRecord::Migration
  def change
		create_table :pharmacology do |t|
		...
		add_index :pharmacology, :DRUG_ID
		add_index :pharmacology, :DRUG_NAME
		add_index :pharmacology, :TARGET_NAME
		add_index :pharmacology, :PHARM_RESULT_ID
  end
end
